...
<body onload="disabledDate()">
	...
	<c:url var="addItmeInIssueListForDirectQty"
		value="/addItmeInIssueListForDirectQty"></c:url>
					...
					<div class="box-content">
						...
						<form id="submitMaterialStore"
							...
							<div class="box-content">
								...
								<div class="col-md-2">Available QTY</div>
								<div class="col-md-3">
									<!-- <select class="form-control chosen" onchange="qtyValidation()"
										name="batchNo" id="batchNo">

									</select> -->
									<input type="text" class="form-control" name="batchQty"
										id="batchQty" disabled />
								</div>
				...
				$.getJSON('${getBatchByItemId}', {
					...
					for (var i = 0; i < len; i++) {
						...
						if (data[i].remainingQty > 0) {
							totalQty = totalQty + data[i].remainingQty;
