...
<body>
	...
	<c:url var="editOfficeMrnProcess" value="/editOfficeMrnProcess" />
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i> Edit Office MRN
							</h3>
							<div class="box-tool">
							...
							$.getJSON('${editOfficeMrnProcess}',{
							 ...
							 function(data) {
								...
								//window.location.reload();
									window.open("${pageContext.request.contextPath}/getOfficeMrnHeaders","_self");
