			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i>Office MRN List
							</h3>
							<div class="box-tool">
								<a href="${pageContext.request.contextPath}/showAddOfficeMrn">Office Add
														...
														<c:choose>
															...
															href="${pageContext.request.contextPath}/editIndent/${mrn.mrnId}"><span
											 					...
											 					<c:choose>
											 						...
											 						<a href="${pageContext.request.contextPath}/deleteOfficeMrn/${mrn.mrnId}" title="Delete" onClick="return confirm('Are you sure want to delete this record');"><span
...
<script type="text/javascript">
			function genPdf(id) {
				...
				window.open('pdfForReport?url=/pdf/getOfficeMrnPdf/'+id
						 );
			...
			function commonPdf() {
				 ...
				 var list = [];
							...
							window.open('pdfForReport?url=/pdf/getOfficeMrnPdf/' + list);
