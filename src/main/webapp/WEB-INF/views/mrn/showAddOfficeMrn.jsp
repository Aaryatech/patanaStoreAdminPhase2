...
<c:url var="exportExcelforMrn" value="/exportExcelforMrn" />
	...
	<c:url var="insertOfficeMrnProcess" value="/insertOfficeMrnProcess" />
			...
			<div class="row">
				<div class="col-md-12">
					<div class="box">
						<div class="box-title">
							<h3>
								<i class="fa fa-bars"></i>Office MRN Header
							</h3>
							<div class="box-tool">
					...
					$
							.getJSON(
									...
									function(data) {
										...
										window
												.open(
														"${pageContext.request.contextPath}/getOfficeMrnHeaders",
														"_self");
