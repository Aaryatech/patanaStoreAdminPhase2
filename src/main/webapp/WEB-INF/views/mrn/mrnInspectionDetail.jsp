											...
											<table width="100%" border="0"
												...
												<thead>
													<tr>
														...
														<th style="text-align: center;">MRN Qty</th>
														<th style="text-align: center;">Approve QTY</th>
														<th style="text-align: center;">Reject QTY</th>
													...
													<c:forEach items="${getMrnHeader.getMrnDetailList}"
														...
														<tr>
															...
															<td><input type="checkbox" name="select_to_approve"
																id="select_to_approve${getMrnDetail.mrnDetailId}"
																value="${getMrnDetail.mrnDetailId}" checked /></td>
															<td><c:out value="${count.index+1}" /></td>
															...
															<td align="right"><input
																...
																name="rejectQty${getMrnDetail.mrnDetailId}" value="0"
																class="form-control" pattern="[+-]?([0-9]*[.])?[0-9]+"
  ...
  function calculation()
  {
	...
	function changeApproveQty(qty,mrnDetailId,mrnQty)
	{
		if(qty<=mrnQty)
		{
		   ...
		   document.getElementById("select_to_approve"+mrnDetailId).checked = true; 
		}
		else
		{
			...
			document.getElementById('rejectQty'+mrnDetailId).value=0;
			 document.getElementById("select_to_approve"+mrnDetailId).checked = false; 
